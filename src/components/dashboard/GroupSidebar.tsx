...
import { Folder, Plus, Loader2, MoreVertical, Edit2, Trash2 } from 'lucide-react'
...
export const GroupSidebar = forwardRef<GroupSidebarRef, GroupSidebarProps>(
  function GroupSidebar(
    ...
    const handleDeleteGroup = async (groupId: string) => {
      if (!confirm('Are you sure you want to delete this group? Analyses in this group will not be deleted.')) {
        return
      }
